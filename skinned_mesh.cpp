...
void skinned_mesh::create_com_objects(ID3D11Device* device, const char* fbx_filename)
{
	...
	// FLAT_SHADING
	create_ps_from_cso(device, "skinned_mesh_flat_shading_ps.cso", flat_shading_pixel_shader.ReleaseAndGetAddressOf());
	create_gs_from_cso(device, "skinned_mesh_flat_shading_gs.cso", flat_shading_geometry_shader.ReleaseAndGetAddressOf());
}
// UNIT.25
